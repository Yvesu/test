 ...
 * @package App\Models
 */
class MakeChartletFile extends Common
{
    protected  $table = 'make_chartlet_file';
    ...
    {
        return $this -> belongsTo('App\Models\Make\MakeChartletFolder','folder_id','id');
    }
    ...
    {
        return $this -> hasMany('App\Models\Make\MakeChartletUser','file_id','id');
    }
    ...
    {
        return $this -> hasMany('App\Models\Make\MakeChartletDownloadLog', 'file_id', 'id');
    }
