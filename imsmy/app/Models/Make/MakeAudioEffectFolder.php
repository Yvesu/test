 ...
 * @package App\Models
 */
class MakeAudioEffectFolder extends Common
{
    protected  $table = 'make_audio_effect_folder';
    ...
    {
        return $this -> hasMany('App\Models\Make\MakeAudioEffectFile','folder_id','id');
    }
