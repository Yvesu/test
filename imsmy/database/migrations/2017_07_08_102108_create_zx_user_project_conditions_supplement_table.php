...
class CreateZxUserProjectConditionsSupplementTable extends Migration {
	...
	public function up()
	{
		Schema::create('zx_user_project_conditions_supplement', function(Blueprint $table)
		{
	...
	{
		Schema::drop('zx_user_project_conditions_supplement');
	}
