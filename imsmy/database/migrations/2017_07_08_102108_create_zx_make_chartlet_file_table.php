...
class CreateZxMakeChartletFileTable extends Migration {
	...
	public function up()
	{
		Schema::create('zx_make_chartlet_file', function(Blueprint $table)
		{
			...
			$table->string('high_address')->default('')->comment('高清资源的网络地址');
			$table->string('super_address')->default('')->comment('超清资源的网络地址');
			...
			$table->bigInteger('sort')->unsigned()->comment('推荐的排列顺序');
	...
	{
		Schema::drop('zx_make_chartlet_file');
	}
