...
class CreateZxMakeAudioEffectFolderTable extends Migration {
	...
	public function up()
	{
		Schema::create('zx_make_audio_effect_folder', function(Blueprint $table)
		{
	...
	{
		Schema::drop('zx_make_audio_effect_folder');
	}
