...
class CreateZxMakeAudioFileTable extends Migration {
	...
	public function up()
	{
		Schema::create('zx_make_audio_file', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->bigInteger('user_id')->unsigned()->index('list_user_id')->comment('上传的用户id');
	...
	{
		Schema::drop('zx_make_audio_file');
	}
