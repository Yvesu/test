...
class CreateZxMakeChartletFolderTable extends Migration {
	...
	public function up()
	{
		Schema::create('zx_make_chartlet_folder', function(Blueprint $table)
		{
			$table->bigInteger('id', true)->unsigned();
			$table->string('name')->index('dirname_name')->comment('贴图目录');
	...
	{
		Schema::drop('zx_make_chartlet_folder');
	}
