                ...
                <div class="sidebar-content">
                    ...
                    <div class="side-header side-content bg-white-op">
                        ...
                        <a class="h5 text-white" href="{{asset('/admin/dashboard')}}">
                            ...
                            <span class="h4 font-w600 sidebar-mini-hide">oobird</span>
                        </a>
                    </div>
                    <!-- END Side Header -->
                    ...
                    <div class="side-content">
                        <ul class="nav-main">
                            <li>
                                <a {{ isActiveMenu('admin::dashboard') }} href="{{ asset('/admin/dashboard') }}">
                                    <i class="fa fa-tachometer"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.dashboard') }}</span>
                                </a>
                            </li>
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-hide">{{ trans('common.management') }}</span>
                            </li>
                            <li {{ isActiveMenu('admin::management::family') }}>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="fa fa-university"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.family_management') }}</span>
                                </a>
                                <ul>
                                    <li>
                                        <a {{ isActiveMenu('admin::management::family::member') }}
                                           href="{{ asset('/admin/management/family/member') }}">
                                            {{ trans('common.member_management') }}
                                        </a>
                                    </li>
                                    <li>
                                        <a {{ isActiveMenu('admin::management::family::setting') }}
                                           href="{{ asset('/admin/management/family/setting') }}">
                            ...
                            <li>
                                <a {{ isActiveMenu('admin::management::user') }}
                                   href="{{ asset('/admin/management/user') }}">
                                    <i class="fa fa-users"></i>
                                <span class="sidebar-mini-hide">
                                    {{ trans('common.user_management') }}
                                </span>
                                </a>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::management::admin') }}
                                   href="{{ asset('/admin/management/user') }}">
                                    <i class="fa fa-users"></i>
                                <span class="sidebar-mini-hide">
                                    {{ trans('common.admin_management') }}
                                </span>
                                </a>
                            </li>
                            <li class="nav-main-heading"><span class="sidebar-mini-hide">APP</span></li>
                            <li {{ isActiveMenu('admin::APP::camera') }}>
                                <a class="nav-submenu" data-toggle="nav-submenu" href="#">
                                    <i class="fa fa-camera"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.camera') }}</span>
                                </a>
                                <ul>
                                    <li>
                                        <a {{ isActiveMenu('admin::APP::camera::UI') }}
                                           href="{{ asset('/admin/app/camera/UI') }}">UI</a>
                                    </li>
                                    <li>
                                        <a {{ isActiveMenu('admin::APP::camera::blur') }}
                                           href="{{ asset('/admin/app/camera/blur') }}">
                                            {{ trans('common.blur') }}
                                        </a>
                                    </li>
                                </ul>
                            ...
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-hide">{{ trans('common.advertisement') }}</span>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::ad::goobird') }} href="{{ asset('/admin/advertisement/goobird') }}">
                                    <i class="fa fa-desktop"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.goobird_advertisement') }}</span>
                                </a>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::ad::user') }} href="{{ asset('/admin/advertisement/user') }}">
                                    <i class="fa fa-bullhorn"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.user_advertisement') }}</span>
                                </a>
                            </li>
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-hide">{{ trans('common.content') }}</span>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::content::video') }} href="{{ asset('/admin/content/video') }}">
                                    <i class="fa fa-cc-mastercard"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.video') }}</span>
                                </a>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::content::photo_album') }} href="{{ asset('/admin/content/photo_album') }}">
                                    <i class="fa fa-cc-mastercard"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.photo_album') }}</span>
                                </a>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::content::topic') }} href="{{ asset('/admin/content/topic') }}">
                                    <i class="fa fa-cc-mastercard"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.topic_content') }}</span>
                                </a>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::content::label') }} href="{{ asset('/admin/content/label') }}">
                                    <i class="fa fa-cc-mastercard"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.label') }}</span>
                                </a>
                            </li>
                            <li class="nav-main-heading">
                                <span class="sidebar-mini-hide">{{ trans('common.system_management') }}</span>
                            </li>
                            <li>
                                <a {{ isActiveMenu('admin::system_management::channel') }} href="{{ asset('/admin/system_management/channel') }}">
                                    <i class="fa fa-cc-mastercard"></i>
                                    <span class="sidebar-mini-hide">{{ trans('common.channel_content') }}</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li>
                    <div class="btn-group">
                        <button class="btn btn-default btn-image dropdown-toggle" data-toggle="dropdown" type="button">
                            <img src="{{ asset('/admin/images/'.session('admin')->avatar) }}" alt="Avatar">
