    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li>{{trans('common.add').trans('common.creation').trans('common.cover')}}</li>
            </ol>
        </div>
        <div class="col-sm-4 col-xs-9">
            <h1 class="page-heading" >
                {{trans('common.add').trans('common.creation').trans('common.cover')}}
            </h1>
        </div>
        <div class="col-sm-8 col-xs-3">
            <!-- Single button -->
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('/admin/creation/cover/index') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 5%;">
            <div class="col-md-10 col-xs-12 block col-md-offset-1">
                ...
                <form class="js-validation-topic form-horizontal"
                      ...
                      action="{{ asset('/admin/creation/cover/insert') }}"
                      method="POST">
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="number" name="name" value="{{ old('name') }}" placeholder="{{ trans('content.name') }}">
                                @if(Session::has('name'))
