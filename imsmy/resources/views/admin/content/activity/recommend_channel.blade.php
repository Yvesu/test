    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="{{ asset('admin/content/activity') }}">{{trans('common.topic_content')}}</a></li>
                <li><a class="link-effect" href="">{{trans('content.recommend')}}</a></li>
            </ol>
        </div>
        <div class="col-sm-4 col-xs-9">
            <h1 class="page-heading" >
                {{trans('content.recommend')}}
            </h1>
        </div>
        <div class="col-sm-8 col-xs-3">
            <!-- Single button -->
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('/admin/content/activity/' . $topic->id) }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row" style="margin-top: 5%;">
        <div class="col-md-10 col-xs-12 block col-md-offset-1">
            <form class="js-validation-channel form-horizontal"
                  ...
                  action="{{ asset('/admin/content/activities/'. $topic->id . '/recommend') }}"
                  method="POST">
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-4 col-md-offset-2" style="padding-top: 20px">
                        ...
                        <label class="css-input switch switch-success">
                            {{ trans('common.no') }} &nbsp;
                            <input type="checkbox" name="recommend_check" id="recommend_check" data-value="recommend" {{ isset($topic->recommend_expires) ? 'checked' : '' }} value="{{ isset($topic->recommend_expires) ? 1 : 0 }}">
                            <span></span>
                            {{ trans('common.yes') }}
                        </label>
                    </div>
                ...
                <div class="form-group hidden" id="recommend">
                    <div class="col-md-4 col-md-offset-2">
                        ...
                        <div class="col-md-6 remove-padding">
                            <input type="text" class="datepicker js-datepicker form-control" name="recommend_date" id="recommend_date" data-date-format="yyyy-mm-dd" value="{{ isset($topic->recommend_start) ? date('Y-m-d',$topic->recommend_start) : '' }}">
                        </div>
                    </div>
                    <div class="col-md-4 ">
                        <label class="col-md-6 control-label" for="recommend_date">{{ trans('content.expire_date') }}</label>
                        <div class="col-md-6 remove-padding">
                            <input type="text" class="datepicker js-datepicker form-control" name="recommend_date" id="recommend_date" data-date-format="yyyy-mm-dd" value="{{ isset($topic->recommend_expires) ? date('Y-m-d',$topic->recommend_expires) : '' }}">
                        </div>
                    </div>
                </div>
                {{--<div class="form-group" style="margin-top:5%">--}}
