    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="">{{trans('content.add_activity')}}</a></li>
            </ol>
        </div>
        ...
        <div class="col-sm-8 col-xs-3">
            ...
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('/admin/content/activity') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-10 col-xs-12 block col-md-offset-1">
            <form class="js-validation-topic form-horizontal"
                  ...
                  action="{{ asset('/admin/content/activities/insert') }}"
                  method="POST">
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        @if(Session::has('tweet'))
                            <div class="help-block text-right animated fadeInDown"><span class="text-danger">{{Session::get('tweet')}}</span></div>
                        @endif
                    </div>
                </div>
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-material">
                            ...
                            <label for="comment">{{ trans('content.activity_comment') }} <span class="text-danger">*</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        <div class="form-material">
                            <input class="form-control" id="comment" name="gold" rows="2">{{ old('comment') }}
                            <label for="comment">赛事金币数 <span class="text-danger">*</span></label>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2" style="padding-top: 20px">
                        <strong>封面 <span class="text-danger">*</span></strong>
                    </div>
                </div>
                <div class="form-group">
...
@section('scripts')
    ...
    <script>
        Lang.name_required = "{{ trans('message.requiredMsg',['attribute' => trans('content.activity_name')]) }}";
