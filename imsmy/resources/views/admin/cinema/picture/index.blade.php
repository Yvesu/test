    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li>
                    <a class="link-effect" href="{{ asset('/admin/cinema/picture/index') }}">
        ...
        <div class="col-sm-8 col-xs-3">
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn btn-primary" href="{{ asset('/admin/cinema/picture/add') }}">
                    {{ trans('common.add_cinema_picture') }}
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="block">
        <ul class="nav nav-tabs nav-tabs-alt">
            <li class="{{ isStyleLabel('style',1,'active','') }}">
                <a href="{{ asset('/admin/cinema/picture/index?style=1') }}">{{ trans('content.already') }}</a>
            </li>
            <li class="{{ isStyleLabel('style',0,'active','') }}">
                <a href="{{ asset('/admin/cinema/picture/index?style=0') }}">{{ trans('content.wait') }}</a>
            </li>
        </ul>
        <div class="block-content tab-content">
            <div class="block-content tab-content">
                {{--搜索--}}
                <form action="{{ asset('/admin/cinema/picture/index') }}" method="get">
                ...
                <table class="table table-bordered table-striped js-dataTable-full">
                    ...
                    <tr>
                        ...
                        <th class="col-md-2 text-center">{{ trans('content.cinema_name') }}</th>
                        <th class="hidden-xs col-md-4 text-center">{{ trans('content.cinema_picture') }}</th>
                    ...
                    @foreach($datas as $data)
                        <tr>
                            ...
                            <td class="text-center">{{ $data -> hasOneCinema['name'] }}</td>
                            <td class="hidden-xs text-center">
                                <div class="col-sm-6 animated fadeIn">
                                    <a class="img-link img-thumb" target="_blank" href="{{ CloudStorage::downloadUrl($data->picture) }}">
                                        <img class="img-responsive" src="{{ CloudStorage::downloadUrl($data->picture) }}" alt="">
                                    </a>
                                </div>
                            </td>
                            ...
                            <td class="text-center">
                                <div class="btn-group">
                                    <a class="btn btn-xs btn-default" title="详情" href="{{ asset('/admin/cinema/picture/details?id=' . $data->id) }}"><i class="fa fa-pencil"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
