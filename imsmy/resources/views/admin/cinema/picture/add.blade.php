    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="{{ asset('admin/cinema/picture/index') }}">{{trans('common.picture_management')}}</a></li>
                <li>{{trans('common.add_cinema_picture')}}</li>
            </ol>
        </div>
        ...
        <div class="col-sm-8 col-xs-3">
            ...
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('/admin/cinema/picture/index') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-10 col-xs-12 block col-md-offset-1">
            <form class="js-validation-channel form-horizontal"
                  ...
                  action="{{ asset('/admin/cinema/picture/insert') }}"
                  method="POST">
                ...
                <div class="form-group">
                    <div class="col-md-8 col-md-offset-2" style="padding-top: 20px">
                        <strong>{{ trans('content.cinema_picture') }}</strong> <span class="text-danger">*</span>
                    </div>
                </div>
                <div class="form-group">
                                ...
                                <div class="img-options-content">
                                    <a href="#" class="btn button-change-profile-picture">
                                        <label for="upload-profile-picture">
                                            ...
                                            <input class="btn-upload" name="background" id="icon" type="file" title style="margin-top:-32px;" onchange="PreviewImage.cinema_picture_preview(this,'icon')">
                                        </label>
                                    </a>
                                </div>
                            </div>
