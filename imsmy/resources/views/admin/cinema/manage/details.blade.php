    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="{{ asset('/admin/cinema/manage/index') }}">
        ...
        <div class="col-md-8 col-md-offset-4">
            <div class="pull-right">
                <form action="{{ asset('/admin/cinema/manage/update') }}" method="POST">
                    ...
                    <a class="btn btn-sm btn-success" type="button"
                       href="{{ asset('/admin/cinema/manage/edit?id=' . $data->id) }}">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="row push-30-t">
                    ...
                    <div class="col-xs-6 col-md-offset-3 remove-padding">
                        <img class="img-responsive img-thumbnail" src="{{ CloudStorage::downloadUrl($data->background_image) }}">
                    </div>
                </div>
