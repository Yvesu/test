    ...
    <div class="content">
        <div class="row" style="margin-top: 5%;">
            <div class="col-md-10 col-xs-12 block col-md-offset-1">
                <form class="js-validation-position form-horizontal" action="/admin/management/position" method="POST">
                            ...
                            <div class="form-material form-material-primary">
                                <select class="form-control" id="department" name="department">
                                    ...
                                    @foreach($departments as $department)
                                        @if((Session::has('postName') || Session::has('postNameDescription')) && old('department') == $department->id)
                                            <option value="{{ $department->id }}" selected="selected">{{ $department->description }}</option>
                                        @else
                    ...
                    <div class="form-group ">
                        <div class="col-sm-4 col-sm-offset-2">
                            <label for="name" class="control-label">{{ trans('management.postName') }} <span class="text-danger">*</span></label>
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="name" name="name" placeholder="{{ trans('management.postName') }}" value="{{ old('name') }}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="description" name="description" placeholder="{{ trans('management.postDescription') }}" value="{{ old('description') }}">
