        ...
        <div class="row items-push">
            ...
            <div class="col-sm-4 col-xs-9">
                <h1 class="page-heading" >
                    {{ trans('common.edit') }}{{ trans('management.department') }}
                </h1>
            </div>
    ...
    <div class="content">
        <div class="row" style="margin-top: 5%;">
            <div class="col-md-10 col-xs-12 block col-md-offset-1">
                <form class="js-validation-department form-horizontal" action="/admin/management/department/edit/{{ $department->id }}" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token()}}">
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-sm-4 col-sm-offset-2">
                            <label for="name">{{ trans('management.deptName') }} <span class="text-danger">*</span></label>
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="name" name="name" placeholder="{{ trans('management.deptName') }}" value="{{ old('name') ? old('name') : $department->name   }}">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class=" form-material form-material-primary">
                                <input type="text" class="form-control" id="description" name="description" placeholder="{{ trans('management.deptDescription') }}" value="{{ old('description') ? old('description') : $department->description }}">
