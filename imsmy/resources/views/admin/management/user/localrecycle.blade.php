        ...
        <div class="row items-push">
            <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
                <ol class="breadcrumb push-10-t">
                    <li>用户管理</li>
                    <li><a class="link-effect" href="">手机用户回收站</a></li>
                </ol>
            </div>
    ...
    <div class="content">
        <!-- Dynamic Table Full -->
            ...
            <div class="block-content tab-content">
                <form action="/admin/user/list/localrecycle" method="get">
                                                        ...
                                                        <div class="col-md-9">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-md-12 " style="margin-top:10px">
                                                                    <a class="btn btn-sm btn-danger" type="button" href="/admin/user/list/delete?id={{ $user->user_id }}" onclick="App.blocks('#my-block', 'close');" title="启用">启 用</a>
                                                                </div>
                                                            </div>
                                                            <br>
                                                        </div>
