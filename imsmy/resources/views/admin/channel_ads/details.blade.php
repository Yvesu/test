    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="{{ asset('/admin/advertisement/channel/details?type='.$ads->type.'&type_id=' . $ads->id) }}">{{ $ads->id }}</a></li>
            </ol>
        </div>
        ...
        <div class="col-sm-8 col-xs-3">
            <div class="pull-right">
                <form action="{{ asset('/admin/advertisement/channel/update?id=' . $ads->id) }}" method="POST">
