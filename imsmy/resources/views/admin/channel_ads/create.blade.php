    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="">{{trans('content.add_ads_channel')}}</a></li>
            </ol>
        </div>
        ...
        <div class="col-sm-8 col-xs-3">
            ...
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('/admin/advertisement/channel/index') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
        ...
        <div class="row" style="margin-top: 5%;">
            <div class="col-md-10 col-xs-12 block col-md-offset-1">
                ...
                <form class="js-validation-topic form-horizontal"
                      ...
                      action="{{ asset('/admin/advertisement/channel/insert') }}"
                      method="POST">
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            <label for="exampleInputEmail1">{{ trans('content.name') }} <span class="text-danger">*</span></label>
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="number" name="number" value="{{ old('name') }}" placeholder="{{ trans('content.name') }}">
                                @if(Session::has('name'))
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            <label for="name">{{ trans('content.ads_type') }} <span class="text-danger">*</span></label>
                            <select class="form-control" name='type'>
                                @foreach($ads_type as $k=>$v)
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            <label for="exampleInputEmail1">{{ trans('content.ads_number') }} <span class="text-danger">*</span></label>
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="number" name="number" value="{{ old('number') }}" placeholder="{{ trans('content.ads_number') }}">
                                @if(Session::has('type'))
                                    <div class="help-block text-right animated fadeInDown"><span class="text-danger">{{Session::get('type')}}</span></div>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="top">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="col-md-7 remove-padding">
                                <input type="time" class="form-control" name="from_time" id="top_time" value="" placeholder="hh:ii">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" id="top">
                        ...
                        <div class="col-md-4">
                            <label class="col-md-5 control-label" for="top_time">{{ trans('content.time') }}</label>
                            <div class="col-md-7 remove-padding">
                                <input type="time" class="form-control" name="end_time" id="recommend_time" value="" placeholder="hh:ii">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2" style="padding-top: 20px">
                            <strong>{{ trans('common.cover') . ' : ' }}</strong>
                        </div>
                    </div>
