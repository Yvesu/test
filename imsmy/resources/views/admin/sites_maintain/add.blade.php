        ...
        <div class="block-content tab-content">
            <div class="col-md-10 col-xs-12 block">
                ...
                <form class="js-validation-topic form-horizontal"
                      ...
                      action="{{ asset('/admin/maintain/insert') }}"
                      method="POST">
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="name" name="title" value="{{ old('title') }}" placeholder="{{ trans('common.title') }}">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <div class="form-material form-material-primary">
                                <input type="text" class="form-control" id="intro" name="keywords" value="{{ old('keywords') }}" placeholder="{{ trans('common.keywords') }}">
                            </div>
                        </div>
                    </div>
