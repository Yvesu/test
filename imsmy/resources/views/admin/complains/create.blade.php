                ...
                <form class="js-validation-topic form-horizontal"
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            <label for="name">{{ trans('content.select_channel') }} <span class="text-danger">*</span></label>
                    ...
                    <div class="form-group" style="margin-top:5%">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <input type="text" name="number" class="form-control" placeholder="{{ trans('content.ads_number') }}">
                        </div>
                    </div>
