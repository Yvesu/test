    ...
    <div class="row items-push">
        <div class="col-sm-12 hidden-xs" style="margin-bottom: 10px;">
            <ol class="breadcrumb push-10-t">
                ...
                <li><a class="link-effect" href="">{{trans('content.edit_channel')}}</a></li>
            </ol>
        </div>
        <div class="col-sm-4 col-xs-9">
            <h1 class="page-heading" >
                {{trans('content.edit_channel')}} : {{ $channel->name }}
            </h1>
        </div>
        <div class="col-sm-8 col-xs-3">
            <!-- Single button -->
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn bg-red" href="{{ asset('admin/system_management/channel/' . $channel->id) }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row" style="margin-top: 5%;">
        <div class="col-md-10 col-xs-12 block col-md-offset-1">
            <form class="js-validation-channel form-horizontal"
                  ...
                  action="{{ asset('/admin/system_management/channel/'. $channel->id) }}"
                  method="POST">
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        ...
                        <div class="form-material form-material-primary">
                            ...
                            <input type="text" class="form-control" id="ename" name="ename" value="{{ old('ename') ? old('ename') : $channel->ename }}">
                        </div>
                        @if(Session::has('name'))
                ...
                <div class="form-group">
                    <div class="col-md-4 col-md-offset-4 col-xs-12" style="margin-top: 20px">
                        <div class="img-container fx-opt-zoom-in">
                            <img class="img-responsive img-thumbnail center-block" id="icon" src="{{ CloudStorage::downloadUrl($channel->icon) }}" alt="" style="width:150px;">
                                ...
                                <div class="img-options-content">
                                    <a href="#" class="btn button-change-profile-picture">
                                        <label for="upload-profile-picture">
                                            ...
                                            <input class="btn-upload" name="channel-icon" id="channel-icon" type="file" title style="margin-top:-32px;" onchange="PreviewImage.channel_preview(this,'icon','{{CloudStorage::downloadUrl($channel->icon)}}')">
                                        </label>
                                    </a>
                                </div>
                            </div>
