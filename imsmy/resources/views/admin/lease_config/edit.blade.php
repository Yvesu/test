    ...
    <div class="row items-push">
        ...
        <div class="col-sm-4 col-xs-9">
            <h1 class="page-heading" >
                {{trans('content.type_edit')}}
            </h1>
        </div>
        <div class="col-sm-8 col-xs-3">
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn btn-primary" href="{{ asset('/admin/config/lease/index') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row" >
        <div class="col-md-12 col-xs-12 block">
            ...
            <form class="js-validation-topic form-horizontal" enctype="multipart/form-data"
                  action="{{ asset('/admin/config/lease/update') }}" method="POST">
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-1">
                        <label for="name">{{ trans('content.type_name') }} <span class="text-danger">*</span></label>
                ...
                <div class="form-group" >
                    <div class="col-md-8 col-md-offset-1" style="margin-top:5%">
                        <label for="name">{{ trans('content.type_father') }} <span class="text-danger">*</span></label>
