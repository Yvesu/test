    ...
    <div class="row items-push">
        ...
        <div class="col-sm-8 col-xs-3">
            <div class="btn-group pull-right" id="family-action">
                <a type="button" class="btn btn-primary" href="{{ asset('/admin/make/effects/file/index') }}">
                    {{ trans('common.cancel') }}
                </a>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12 block">
            <form class="js-validation-topic form-horizontal" enctype="multipart/form-data"
                  action="{{ asset('/admin/make/effects/file/insert') }}" method="POST">
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        <label for="name">{{ trans('common.upload') . trans('common.effects') }} <span class="text-danger">*</span></label>
                        <div class="row normal">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="upload-file">
                                    <a type="button" id="pickfiles" class="btn bg-primary pull-right" href="#">
                                        {{ trans('common.upload') . trans('common.effects') }}
                                    </a>
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        <label for="name">{{ trans('common.upload') . trans('common.high') . trans('common.effects') }} </label>
                        <div class="row">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="upload-high-file">
                                    <a type="button" id="high_pickfiles" class="btn bg-primary pull-right" href="#">
                                        {{ trans('common.upload') . trans('common.high') . trans('common.effects') }}
                                    </a>
                ...
                <div class="form-group" style="margin-top:5%">
                    <div class="col-md-8 col-md-offset-2">
                        <label for="name">{{ trans('common.upload') . trans('common.super') . trans('common.effects') }} </label>
                        <div class="row super">
                            <div class="col-md-12">
                                <div class="btn-group pull-right" id="upload-super-file">
                                    <a type="button" id="super_pickfiles" class="btn bg-primary pull-right" href="#">
                                        {{ trans('common.upload') . trans('common.super') . trans('common.effects') }}
                                    </a>
