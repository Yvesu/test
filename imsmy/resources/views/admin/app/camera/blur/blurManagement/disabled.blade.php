...
<div class="block-content tab-content">
    <div class="tab-pane active">
                            ...
                            <div class="modal-dialog modal-dialog-popin">
                                <div class="modal-content">
                                            ...
                                            <div class="row" style="margin-bottom: 30px">
                                                <div class="col-md-6" style="margin-top: 30px;">
                                                    <div class="form-material">
                                                        ...
                                                        <img class="img-thumbnail"
                                                             src="{{
                                                                downloadUrl('blur_class/'. $class->id . '/' . $class->icon_sm)
                                                             }}">
                                                        @endif
                                                    </div>
                                                </div>
                                                <div class="col-md-6" style="margin-top: 30px;">
                                                    <div class="form-material">
                                                        ...
                                                        <img class="img-thumbnail"
                                                             src="{{
                                                                downloadUrl('blur_class/'. $class->id . '/' . $class->icon_lg)
                                                             }}">
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    <div class="modal-footer">
                                        <form action="{{ asset('/admin/app/camera/blur/class/enabled/'. $class->id) }}" method="POST">
                                            <input type="hidden" name="_token" value="{{ csrf_token()}}">
                                            <button class="btn btn-sm bg-red" type="submit" ><i class="fa fa-ban"></i> {{ trans('app.enable') }}</button>
        ...
        {!! (new \App\Services\Presenter($classes->appends(['type' => 0])))->render() !!}
    </div>
</div>