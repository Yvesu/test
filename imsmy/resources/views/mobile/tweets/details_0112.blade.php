    ...
    @if(!empty($relate))
        <ul class="hot-list m0 fs">
            @foreach($relate as $item)
                <li class="hot-list-item padding2 active-change-bg1 m0 log zg" data-log="相关推荐视频点击数" data-zg="点击相关推荐影片" data-catename="运动" data-duration="308">
                    <a class="pic new-view-link" data-index="0" data-type="0" data-id="16064" href="{{ asset('/tweet/'.$item['id']) }}">
...
//                var videoImgStr = $(".video-face img").attr("src");
    ...
    {{--<script type="text/javascript">--}}
        ...
        {{--wx.config({--}}
            ...
            {{--appId: 'wx58ca0513ae707e20', // 必填，公众号的唯一标识--}}
