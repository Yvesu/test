...
<html>
    <head>
        ...
        <link rel="stylesheet" href="{{ url('/home/css/styles.css ') }}">
    ...
    <body>
        <div class="container-fluid main-container text-center">
            <div class="row">
                <div class="col-lg-12">
                    <img id="logo" src=" {{ asset('/home/img/logo.png') }}"  width="50%" height="50%" center-block img-responsive">
                    <h2 style="color: white">维护中...</h2>
                    <div class="center-block underline-stroke"></div>
                </div>
                <div class="col-lg-12">
                    <p style="color: white">系统正在维护中，可能需要一点时间，我们建议您稍后再试。</p>
                </div>
            </div>
            {{--<div class="countdown">--}}
                {{--<div class="time-slot">--}}
