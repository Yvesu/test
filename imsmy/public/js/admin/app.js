...
var App = function() {
    ...
    var uiBlocksApi = function($block, $mode) {
        ...
        var $iconContent            = 'fa fa-arrow-circle-o-up';
        var $iconContentActive      = 'fa fa-arrow-circle-o-down';
    ...
    var uiHandleTheme = function() {
        ...
        jQuery('[data-toggle="theme"]').on('click', function(){
            ...
            document.cookie = "skin="+$theme+expires+"; path=/";
    ...
    var uiHelperTableToolsSections = function(){
        ...
        var $tableRows  = jQuery('.js-table-sections-header > tr > td:first-child', $table);

        //重复绑定 先解除再绑定
        $tableRows.unbind();
        // When a row is clicked in tbody.js-table-sections-header
        $tableRows.click(function(e) {
            var $row    = jQuery(this).parent('tr');
